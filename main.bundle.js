...
var AppService = (function () {
    ...
    function AppService(http) {
        ...
        this.regionCode = "HK";
        this.aws = "https://m071xknb9b.execute-api.ap-northeast-1.amazonaws.com/prod/rss";
    }
    ...
    AppService.prototype.rssfeed = function (program) {
        //mystery,digi
        var url = this.aws + "?format=json&code=" + program;
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.listyoutube = function () {
        this.youtubeShow = true;
    };
    AppComponent.prototype.rss = function (program) {
        var _this = this;
        this.appservice.rssfeed(program).subscribe(function (res) { return _this.listRssExe(res.json()); });
    };
    ...
    AppComponent.prototype.listRssPage = function (code) {
        this.rss(code);
    ...
    AppComponent.prototype.listRssExe = function (json) {
        this.rsslist = json.data;
    };
    AppComponent.prototype.playrss = function (item) {
